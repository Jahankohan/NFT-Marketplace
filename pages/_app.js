    ...
    <div className="flex-grow flex-col min-h-screen">
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div
            className="hidden flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium justify-between items-center w-full md:flex md:w-auto md:order-1"
            id="mobile-menu-4"
          >
            <Link href="/">
      ...
      <Component {...pageProps} />
      <footer className="bg-gray-800 mt-20 justify-center">
